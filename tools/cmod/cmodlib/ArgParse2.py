...
cmd_description_report   = "report command description"
cmd_description_stat     = "stat command description"
cmd_description_format   = "format command description"
cmd_description_analyze  = "analyze command description"
cmd_description_tdd      = "tdd command description"
...
cmd_description_msgs = [ \
    ...
    cmd_description_report, \
    cmd_description_stat, \
    cmd_description_format, \
    cmd_description_analyze, \
    cmd_description_tdd, \
...
cmd_usage_report   = "report command example"
cmd_usage_stat     = "stat command example"
cmd_usage_format   = "format command example"
cmd_usage_analyze  = "analyze command example"
cmd_usage_tdd      = "tdd command example"
...
cmd_help_report   = "report command help message"
cmd_help_stat     = "stat command help message"
cmd_help_format   = "format command help message"
cmd_help_analyze  = "analyze command help message"
cmd_help_tdd      = "tdd command help message"
